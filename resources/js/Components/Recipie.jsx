...
function Recipie({ title, img, id, email, saved }) {
    return (
        <div className="hover:shadow-lg p-3 rounded-lg transition-all ease-in-out duration-200">
            ...
            <div className='w-full flex flex-row justify-between mb-2'>
                ...
                { !saved && <Link as="button" method='post' data={{'id': id, 'email': email}} href={route('save-recipie')} className=" pt-1"><i className="fi fi-rr-bookmark text-xl"></i></Link> }
            </div>
